...
def fit_nn_heart_neurons_f1(c):
    ...
    print(-precision_score(y_val, y_pred_val), -recall_score(y_val, y_pred_val), f1_score(y_val, y_pred_val))
    
    return -np.array([f1_score(y_val, y_pred_val)])